...
$result = $con->query('SELECT * FROM `clothes`')
...
<body>
        <header>
            ...
            <ul>
                ...
                <li><a href="kids.php" class="color-cate">Kids</a></li>
        ...
        <div class="all-products">
            ...
            <?php foreach($result as $row):?>
                <article class="clothing-list__details">
                    <img class="clothing-list__photo" src="/img/<?php echo $row['foto'] ?>" alt="">
                    <header>
                        <h3><?php echo $row['titel']?></h3>
                        <div>€<?php echo $row['prijs']?></div>
                    </header>
